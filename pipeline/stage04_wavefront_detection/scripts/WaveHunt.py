...
def WaveHuntTimes_Globality(UpTrans,nCh,RecordingSet,ChLabel,SPATIAL_SCALE,MIN_CH_NUM, FullWave, FullWaveUnique, FullWaveSize, FullWaveTime, FullWaveUniqueSize):
...
if __name__ == '__main__':
    ...
    FullWave, FullWaveUnique, FullWaveSize, FullWaveTime, FullWaveUniqueSize, MAX_IWI = MAX_IWI_Search(UpTrans,nCh,ChannelSet,ChLabel, Wave, WaveSize, WaveTime, ExpectedTrans, args.Acceptable_rejection_rate)
    ...
    WaveHunt = WaveHuntTimes_Globality(UpTrans, nCh, RecordingSet, ChLabel, evts.annotations['spatial_scale'], args.MIN_CH_NUM, FullWave, FullWaveUnique, FullWaveSize, FullWaveTime, FullWaveUniqueSize)
