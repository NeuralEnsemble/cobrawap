...
|__minima__|detects UP transitions as local minima. |`NUM_INTERPOLATION_POINTS`, `USE_QUADRATIC_INTERPOLATION`, `MIN_PEAK_DISTANCE_MAXIMA`, `MINIMA_PERSISTENCE`, `MAXIMA_THRESHOLD_FRACTION`|
>>>>>>> 3e08e934... Readme in stage 03 updated
