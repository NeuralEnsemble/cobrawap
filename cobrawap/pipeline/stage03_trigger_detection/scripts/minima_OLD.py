...
CLI.add_argument("--maxima_threshold_window", nargs='?', type=none_or_float, default=2,
...
if __name__ == '__main__':
    ...
    duration = float(asig.t_stop.rescale('s').magnitude - asig.t_start.rescale('s').magnitude)
    if args.maxima_threshold_window is None or args.maxima_threshold_window > duration:
        args.maxima_threshold_window = duration
